...
Embedded wallets are billed based on "monthly active wallets". An active wallet is defined as a wallet where a user logs in during the billing period. Embedded wallets are completely free up to 1,000 monthly active wallets, and $0.02 per wallet after that. 
